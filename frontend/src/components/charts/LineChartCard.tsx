...
export function LineChartCard({ title, data, color = "#2563EB" }: { title: string; data: Point[]; color?: string }) {
  return (
    <Card>
      ...
      <ResponsiveContainer width="100%" height={240}>
        <LineChart data={data}>
          ...
          />
          <Line type="monotone" dataKey="value" stroke={color} strokeWidth={3} dot={{ r: 3 }} animationDuration={900} />
        </LineChart>
      </ResponsiveContainer>
    </Card>
  );
